# HW6 - k3s Deployment Evidence

Live Demo Video: (To be added)
...
#### `sudo k3s kubectl describe deployment web -n mcapp`
output:
```
(To be added after deployment)
```
...
### 5. Application Access Tests

#### `curl http://localhost:30080/`
output:
```
(To be added after deployment - should return HTML page)
```

#### `curl http://localhost:30080/api/health`
output:
```
(To be added after deployment - should return health status)
```

#### `curl http://localhost:30080/api/names`
output:
```
(To be added after deployment - should return list of names)
```
...
#### Backend API logs
```bash
sudo k3s kubectl logs -n mcapp -l app=api --tail=20
```
output:
```
(To be added after deployment)
...
#### Frontend logs
```bash
sudo k3s kubectl logs -n mcapp -l app=web --tail=20
```
output:
```
(To be added after deployment)
...
#### Database logs
```bash
sudo k3s kubectl logs -n mcapp -l app=db --tail=20
```
output:
```
(To be added after deployment)
...
## Docker Swarm Deployment Evidence (HW5 Reference)

### Live Demo Video
https://youtu.be/1rOy-jnlwb0
